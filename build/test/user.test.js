...
describe('POST /register_user', () => {
    test('should respond with a 200 status code', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(user_1.default).post('/register_user').send({
...
describe('POST /login', () => {
    test('should respond with a 200 status code', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(user_1.default).post('/login').send({
            email: "suilppm@gmail.com",
            password: "12sd3sdakajasd"
        });
        expect(response.statusCode).toBe(200);
